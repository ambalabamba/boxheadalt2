...
if __name__ == '__main__': # rest in pieces
    FarmBot('thegthing',  'lolok', '45.63.119.253', 1031)
    ...
    FarmBot('mainstreamnyga',  'lolok', '45.63.119.253', 1031)
    FarmBot('maderfakyr',  'lolok', '45.63.119.253', 1031)
    FarmBot('thiswillbeez',  'lolok', '45.63.119.253', 1031)
    FarmBot('thatwillbehoney',  'lolok', '45.63.119.253', 1031)
    FarmBot('beargummi',  'lolok', '45.63.119.253', 1031)
    FarmBot('headquat',  'lolok', '45.63.119.253', 1031)
    FarmBot('quacklack',  'lolok', '45.63.119.253', 1031)
    FarmBot('smackdack',  'lolok', '45.63.119.253', 1031)
    FarmBot('westcoastinthis',  'lolok', '45.63.119.253', 1031)
    FarmBot('takepictureofem',  'lolok', '45.63.119.253', 1031)
