...
if __name__ == '__main__': # rest in pieces
    FarmBot('yarightlol',  'supercole', '45.63.119.253', 1031)
    FarmBot('yarightlol2',  'supercole', '45.63.119.253', 1031)
    FarmBot('yarightlol3',  'supercole', '45.63.119.253', 1031)
    FarmBot('yarightlol4',  'supercole', '45.63.119.253', 1031)
    FarmBot('yarightlol5',  'supercole', '45.63.119.253', 1031)
    FarmBot('yarightlol6',  'supercole', '45.63.119.253', 1031)
    FarmBot('yarightlol7',  'supercole', '45.63.119.253', 1031)
    FarmBot('yarightlol8',  'supercole', '45.63.119.253', 1031)
    FarmBot('yarightlol9',  'supercole', '45.63.119.253', 1031)
    FarmBot('yarightlol10',  'supercole', '45.63.119.253', 1031)
    FarmBot('yarightlol11',  'supercole', '45.63.119.253', 1031)
    FarmBot('yarightlol12',  'supercole', '45.63.119.253', 1031)
    FarmBot('yarightlol13',  'supercole', '45.63.119.253', 1031)
    FarmBot('yarightlol14',  'supercole', '45.63.119.253', 1031)
    FarmBot('yarightlol15',  'supercole', '45.63.119.253', 1031)
